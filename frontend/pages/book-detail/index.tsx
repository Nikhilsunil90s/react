...
const  BookDetail: React.FC= () => {
    ...
    const bookDetail= (id) => {
        ...
        .then( response => {
            ...
            setBooksDescription(response.data.title);
            setIsLoading(false)
        })
        .catch (err => {
    ...
    return (
        ...
        <NavBar bg="#fff" textColor="#191919" />
                <Container maxWidth="lg">
                    <Box my={5} display="flex" justifyContent="center" style={{marginBottom: 0}}><Typography variant="h3" style={{color: 'black'}}>Book Detail</Typography></Box>
                </Container>
